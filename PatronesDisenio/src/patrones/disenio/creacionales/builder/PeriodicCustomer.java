 ...
 *
 */
public class PeriodicCustomer extends ABCustomer {

	protected PeriodicCustomer(LocalDate date, String name, int numPeople, int numDays) {
	...
	void createReservation() {
		...
		this.reservacion.setTotalAmount(this.reservacion.getNumPeople() * this.reservacion.getNumDays() * this.TARIFA_POR_PERSONA_POR_NOCHE_PC);
